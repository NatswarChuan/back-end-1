...
$products = $productModel->getProductsPages($page, $perPage);
                ...
                <div class="wrapper clear-fix">
                    <div xmlns:v="http://rdf.data-vocabulary.org/" id="breadcrumbs">
                        <ul itemprop="breadcrumb" class="breadcrumb">
                            ...
                            <li typeof="v:Breadcrumb"><a property="v:title" rel="v:url" href="./nha-dat-ban.html" title="Mua bán">Mua bán</a> </li>
                        </ul>
                    </div>
                    <!-- start -->
                    ...
                    <div class="full_spmain">
                        ...
                        <div align="center">
                            <?php
                            echo TienIch::PaginationProduct($page,$perPage,$count);
                            ?>
                        </div>
